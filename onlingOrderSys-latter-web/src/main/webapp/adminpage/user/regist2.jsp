...
<link href="${APP_PATH}/static/verify/css/bootstrap.min.css" rel="stylesheet">
<link href="${APP_PATH}/static/verify/css/gloab.css" rel="stylesheet">
<link href="${APP_PATH}/static/verify/css/index.css" rel="stylesheet">
<script src="${APP_PATH}/static/verify/js/jquery-1.11.1.min.js"></script>
<script src="${APP_PATH}/static/verify/js/register.js"></script>
<title>后台注册</title>
</head>
<body class="bgf4">
