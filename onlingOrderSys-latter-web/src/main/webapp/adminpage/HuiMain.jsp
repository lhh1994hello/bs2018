...
<%-- <%@ include file="${APP_PATH}/adminpage/public/clock.jsp"%>
 --%>
</head>
<body>
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		...
		<a class="logo navbar-logo f-l mr-10 hidden-xs" href="javascript:void(0);">订餐管理系统后台</a>
		<a class="logo navbar-logo f-l mr-10 hidden-xs" href="javascript:void(0);">
			<font style="font-size: 10px;" id="time_clock_id">2018年05月24日,星期六 13:28:33</font>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li>管理员</li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">${session_adminUser.username}<i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="javascript:;" onClick="myselfinfo()">个人信息</a></li>
						<li><a href="#">切换账户</a></li>
						<li id="quit_id"><a href="javascript:void(0);">退出</a></li>
				</ul>
			</li>
				<li id="Hui-msg"> 
					<a href="#" title="消息"><span class="badge badge-danger"></span>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="${APP_PATH}/adminpage/menu/HuiaddMenu2.jsp" data-title="添加菜谱" href="javascript:void(0)">添加菜谱</a></li>
					<li><a data-href="${APP_PATH}/adminLookMenu" data-title="查看菜谱" href="javascript:void(0)">查看菜谱</a></li>
					<li><a data-href="${APP_PATH}/getCategoryList" data-title="管理菜系" href="javascript:void(0)">管理菜系</a></li>
			</ul>
		</dd>
	</dl>
	...
	<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="${APP_PATH}/adminpage/order/orderList.jsp" data-title="全部订单" href="javascript:;">全部订单</a></li>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${APP_PATH}/adminpage/member/memberList.jsp" data-title="会员列表" href="javascript:;">会员列表</a></li>
					<li><a data-href="${APP_PATH}/adminpage/member/member_del.jsp" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
					<li><a data-href="${APP_PATH}/adminpage/feedback/feedback.jsp" data-title="会员反馈" href="javascript:;">会员反馈</a></li>
		...
		<dl id="menu-tongji">
			...
			<dd>
				<ul>
					<li><a data-href="${APP_PATH}/adminpage/charts/categoryChart.jsp" data-title="菜系统计" href="javascript:void(0)">菜系统计</a></li>
					<!-- <li><a data-href="charts-2.html" data-title="时间轴折线图" href="javascript:void(0)">时间轴折线图</a></li>
					<li><a data-href="charts-3.html" data-title="区域图" href="javascript:void(0)">区域图</a></li> -->
					<li><a data-href="${APP_PATH}/adminpage/charts/menuCharts.jsp" data-title="菜品统计" href="javascript:void(0)">菜品统计柱状图</a></li>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="welcome.html" id="myTable">我的桌面</span>
					<em></em>
				</li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<!-- 欢迎页面 -->
			<iframe id="welcome" scrolling="yes" frameborder="0" src="${APP_PATH}/adminpage/public/welcome.jsp"></iframe>
	</div>
</div>
</section>
...
$(function(){
	...
	if (url.indexOf("?") != -1) {   
		...
		var  param=url.substring(index+1);
 		if(param=="edit"){
 			$("#welcome").attr("src","${APP_PATH}/adminpage/member/memberList.jsp");
		}
		//添加完菜品之后跳转到菜单显示页面
		if(param=="addMenu"){
 			$("#welcome").attr("src","${APP_PATH}/adminLookMenu");
		}
	 }
	var timer = setInterval(realSysTime,1000);
	/*  */
	...
	$("#myTable").click(function(){
		//$("#welcome").attr("src","${APP_PATH}/adminpage/public/msg.jsp");
		$("#welcome").attr("src","${APP_PATH}/adminpage/public/welcome.jsp");
	});
	
	$("#quit_id").click(function(){
		window.location.href="${APP_PATH}/quit";
	});
